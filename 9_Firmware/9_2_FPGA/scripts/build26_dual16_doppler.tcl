################################################################################
# build26_dual16_doppler.tcl
#
# AERIS-10 Build 26: Dual-16 Doppler Timing Validation
# Target: XC7A200T-2FBG484I
# Design: radar_system_top
# Base:   Build 23 production flow, updated for dual 16-pt Doppler FFT
#
# Changes vs Build 23:
#   - Includes all current top-level RTL sources automatically so the build
#     stays aligned with the checked-in production design.
#   - Validates the corrected dual 16-point staggered-PRF Doppler path.
#   - Preserves the production implementation/report flow and bitstream output.
#
# Usage:
#   vivado -mode batch -source build26_dual16_doppler.tcl
#
...
puts "================================================================"
puts "  AERIS-10 Build 26: Dual-16 Doppler Timing Validation"
...
# --- Add RTL sources ---
# Auto-discover current top-level RTL so the build stays aligned with the
# checked-in design instead of a stale hand-maintained file list.
set rtl_files [lsort [glob -nocomplain "${rtl_dir}/*.v"]]
...
puts {  [13/15] Log scan - see build26.log}
...
set summary_fh [open "${report_dir}/00_build26_summary.txt" w]
puts $summary_fh "================================================================"
puts $summary_fh "  AERIS-10 Build 26 - Dual-16 Doppler Timing Validation"
puts $summary_fh "================================================================"
puts $summary_fh ""
...
puts $summary_fh "  Build 26 Result: LUTs/FFs in report_utilization; BRAM=17, DSP=142 observed"
puts $summary_fh ""
...
close $summary_fh
puts "  Summary written to: ${report_dir}/00_build26_summary.txt"
